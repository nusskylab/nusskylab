...
\lhead{\emph{{\sc Skylab}: Orbital Project Platform}}  % Set the left side page header to "Contents"
...
\input{Chapters/Chapter_Introduction} % Introduction

\input{Chapters/Chapter_Background} % Background

\input{Chapters/Chapter_Workflow} % Orbital workflow

\input{Chapters/Chapter_Admin_Portal} % Admin portal

\input{Chapters/Chapter_Public_Profile} % Public profile

\input{Chapters/Chapter_Security} % Security

\input{Chapters/Chapter_Testing} % Testing

\input{Chapters/Chapter_Conclusion} % Conclusion
...
% \input{Appendices/Appendix_Issues}	% Appendix Title
