...
% Min: sentence doesn't read right.  Please fix.
...
% Min: Good to add to this list with whether these issues were closed or not accepted to be modified: e.g., \item (closed on XX YY as implemented) Item ZZ.
\begin{itemize}
...
% Min: too general, make more specific.
