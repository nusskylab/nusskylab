...
- Too many clicks to various functionality.
- Skylab: Effective tool to help monitor each team's evaluations. Very helpful.
...
- -
- Eval 1 -- generally was just the late opening of Milestone 1 submission on Skylab as the feature was still being developed. Aside from that there weren't actually any complaints on this matter.
...
- Login screen and functionality work fine, albeit looking a bit plain (just me being picky in design). Not major issues to note!

**How does the home screen look like? Anything misplaced? Or anything missing?**
- Use "Submit evaluations" as default tab. "View all your teams" is not really necessary.
- Home screen is okay pre-login. Post-login, suggest that "View all your teams" be moved to the last -- advisors don't really look at team details usually.
...
- Viewing if evaluations were done should be done in a lot less clicks.
- To see each team's progress in terms of what peer teams they have evaluated, the current process is:
...
- Yes, previous submissions will be useful, so as to compare if they have managed to add in things mentioned in the previous evaluation.
- Would be nice if embedding of videos could be done on Skylab (so students can just watch the videos on Skylab without redirection), but understandable that different video hosting sides have different embedding rules so this may be tough to implement.
...
- Suggest all options to use "Strongly Disagree / ... / Strongly Agree" to keep it consistent.
- Evaluating teams currently involves the following process:
...
- Fixed project log format for all students instead of free-style.
- The following suggestions lean more towards the students side.
...
- -
- Not really. Unable to provide feedback for this.

**What are other things you want to tell us?**
- Thanks!
- Nothing else! Everything I wanted to say is available in each section.
