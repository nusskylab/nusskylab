...
describe Evaluating do
  it 'is invalid with required field missing' do
    team1 = FactoryGirl.create(:team, team_name: 'Evaluating team 1',project_level: 'Gemini', adviser: nil,
                               mentor: nil)
  ...
  it 'is invalid with combination of evaluator_id and evaluated_id taken' do
    team1 = FactoryGirl.create(:team, team_name: 'Evaluating team 1',project_level: 'Gemini', adviser: nil,
                               mentor: nil)
    team2 = FactoryGirl.create(:team, team_name: 'Evaluating team 2',project_level: 'Gemini', adviser: nil,
                               mentor: nil)
