...
RSpec.describe MentorMatchings, type: :model do
    ...
    it 'is valid as each mentor matchings has 1 choice' do
        ...
        expect(FactoryGirl.create(:mentor_matchings, team: team1, mentor: mentor1, choice_ranking: 1)).to be_valid
        expect(FactoryGirl.create(:mentor_matchings, team: team1, mentor: mentor2, choice_ranking: 2)).to be_valid
        expect(FactoryGirl.create(:mentor_matchings, team: team1, mentor: mentor3, choice_ranking: 3)).to be_valid
    end
end