...
RSpec.describe MentorMatching, type: :model do
  it 'is invalid with choices missing' do
    expect(FactoryGirl.build(:mentor_matching, choice_ranking: nil)).not_to be_valid
  end
  ...
  it 'is invalid as team choice have already been selected' do
    ...
    FactoryGirl.create(:mentor_matching, team: team1, mentor: mentor1, choice_ranking: 1)
    FactoryGirl.create(:mentor_matching, team: team1, mentor: mentor2, choice_ranking: 2)
    FactoryGirl.create(:mentor_matching, team: team1, mentor: mentor3, choice_ranking: 3)

    expect(FactoryGirl.build(:mentor_matching, team: team1, mentor: mentor4, choice_ranking: 1)).not_to be_valid
    expect(FactoryGirl.build(:mentor_matching, team: team1, mentor: mentor4, choice_ranking: 2)).not_to be_valid
    expect(FactoryGirl.build(:mentor_matching, team: team1, mentor: mentor4, choice_ranking: 3)).not_to be_valid
  end

  it 'is valid as each mentor matchings has 1 choice' do
    #for student
    user1 = FactoryGirl.create(:user, email: 'test2@gmail.com', uid: 'https://openid.nus.edu.sg/a0000002')
    user2 = FactoryGirl.create(:user, email: 'test3@gmail.com', uid: 'https://openid.nus.edu.sg/a0000003')
    user3 = FactoryGirl.create(:user, email: 'test4@gmail.com', uid: 'https://openid.nus.edu.sg/a0000004')
    ...
    expect(FactoryGirl.create(:mentor_matching, team: team1, mentor: mentor1, choice_ranking: 1)).to be_valid
    expect(FactoryGirl.create(:mentor_matching, team: team1, mentor: mentor2, choice_ranking: 2)).to be_valid
    expect(FactoryGirl.create(:mentor_matching, team: team1, mentor: mentor3, choice_ranking: 3)).to be_valid
  end
end
