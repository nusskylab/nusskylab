...
RSpec.describe Admin, type: :model do
  ...
  it 'is invalid to associate with admin#user' do
    user = FactoryGirl.create(:user, email: 'user1@admin.model.spec', uid: 'uid1.admin.model.spec')
  ...
  it 'should have admin? class method' do
    user1 = FactoryGirl.create(:user, email: 'user2@admin.model.spec', uid: 'uid2.admin.model.spec')
    user2 = FactoryGirl.create(:user, email: 'user3@admin.model.spec', uid: 'uid3.admin.model.spec')
